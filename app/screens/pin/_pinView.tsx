...
export default function PinView({ pin }: { pin: boolean }) {
  return (
    <ModalWrapper>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.buttonContainer}>
            {pin ? (
              <>
                <Button
                  onPress={() => router.push("/(modals)/pin")}
                ...
                <TouchableOpacity
                  onPress={() => router.push("/(modals)/removalPin")}
                  style={styles.removeButton}
                >
                  <Typo color={Colors.dark.warning} fontWeight="600">
                    Remover Proteção
                  </Typo>
                </TouchableOpacity>
              </>
